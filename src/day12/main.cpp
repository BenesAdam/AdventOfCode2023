...
int main(int argc, char* argv[])
{
	...
	std::cout << "Number of different arrangements: " << cConditionRecord::NumberOfPossibleWay(records_part1) << std::endl;
	...
	std::cout << "Number of different arrangements (part 2): " << cConditionRecord::NumberOfPossibleWay(records_part2) << std::endl;
